...
from shared.database.dsrag_database import create_pinecone_db
from dsrag.database.vector.pinecone_db import PineconeDB
...
class TestCreateKB(unittest.TestCase):
    def test__001_create_kb_and_query(self):
        ...
        vector_db = create_pinecone_db("test")
